...
import {
    ...
    Sparkles, Pencil, Briefcase, Building2, Search, MapPin, CheckCircle, HelpCircle, Zap, PointerOff,
    AlertCircle, Gift
} from 'lucide-react';
...
import { KNOWN_AUDIO_APP_BUNDLES, normalizeAudioBundle } from './settings/audioBundles';
import { StarRating } from './settings/StarRating';
import { MockupNativelyInterface } from './settings/MockupNativelyInterface';
...
const SettingsOverlay: React.FC<SettingsOverlayProps> = ({ isOpen, onClose, initialTab = 'general' }) => {
    ...
    // Natively-hosted backend was removed; this stub exists only so legacy UI
    // checks compile. It is always false.
    const hasNativelyKey = false;
        ...
        const loadSttSettings = async () => {
            try {
                ...
                if (creds) {
                    ...
                    // hasNativelyKey removed (Natively-hosted backend purged)
